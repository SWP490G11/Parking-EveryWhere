...
export default function HeaderComp({ username, id }) {
  const menuitems = [
    ...
    {
      label: "Parking Of Me ",
      onClick: () => navigate(`/parking-infor/${id}`),
      key: "app",
      icon: <i class="bi bi-p-circle"></i>,
    },
    {
      label: "Car",
      onClick: () => navigate(`/car-type`),
      key: "app",
      icon: <i class="bi bi-p-circle"></i>,
    },
    {
            ...
            footer={[
              <Button
                ...
                onClick={() => {
                  ...
                  axios
                    .put(
                      `${process.env.REACT_APP_Backend_URI}api/User/ChangePassword?id=${id}`,
                      password
                    )
                    .then(() => {
                  ...
                  rules={[
                    {
                      required: true,
                      max: 50,
                      message: `New password must have riquired`,
                    },
                    {
                ...
                >
                  <Input.Password
                    ...
                    onChange={(pass) => {
                      setPassword({
                        ...password,
                        confirmNewPassword: pass.target.value,
                      });
                    }}
                  />
                </Form.Item>
